...
class AIDE_Model(nn.Module):
    ...
    def forward(self, x):
        ...
        x_minmin = (x_minmin - self.imagenet_mean) / self.imagenet_std
        x_maxmax = (x_maxmax - self.imagenet_mean) / self.imagenet_std
        x_minmin1 = (x_minmin1 - self.imagenet_mean) / self.imagenet_std
        x_maxmax1 = (x_maxmax1 - self.imagenet_mean) / self.imagenet_std
